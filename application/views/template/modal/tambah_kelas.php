                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-12 col-lg-12 controls">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" value="" placeholder="Teknik Sipil">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-12 col-lg-12 controls">
                                ...
                                <input type="file" name="foto" id="foto" class="form-control" value="" placeholder="Foto Kelas">
                            </div>
                        </div>
                    </div>
                </div>                            
